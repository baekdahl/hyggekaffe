...
namespace PoolTracker
{
    public partial class Form2 : Form
    {
        ...
        public void Run() 
        {
            ...
            Application.Idle += new EventHandler(delegate(object sender, EventArgs e)
            {
                ...
                if (originalImage != null && tab != null && tabControl1.SelectedIndex == 0)
                {
                    ...
                    if (!tab.isTableOccluded(originalImage,0.98,1.06,1))
                    {
                       // occluded = !occluded;
                       locateBalls();
                    }
        ...
        public void writeVideo()
        {
            ...
            if (writer == null)
            {
                writer = new VideoWriter("out.avi", /*CvInvoke.CV_FOURCC('P','I','M','1')*/ 0, 10, videoFrame.Width, videoFrame.Height, true);
            }
