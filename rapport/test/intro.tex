...
\begin{figure}[H]
  \centering
  \subfloat[Input image.]{\includegraphics[width=0.3\textwidth]{images/test/light/balls_id_apart_input}}
\quad
   \subfloat[All balls identified correctly.]{\includegraphics[width=0.3\textwidth]{images/test/light/balls_id_apart_output}}
\quad
...
\begin{figure}[H]
  \centering
  \subfloat[Input image.]{\includegraphics[width=0.3\textwidth]{images/test/mixed/balls_id_apart_input}}
\quad
   \subfloat[All balls identified correctly.]{\includegraphics[width=0.3\textwidth]{images/test/mixed/balls_id_apart_output}}
\quad
