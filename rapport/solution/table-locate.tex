...
The code iterates through the different contours found by FindContours. These contours are tested whether  they could be the cloth by using a few certain conditions:
...
\begin{figure}[H]
\centering
\subfigure[Mask of cloth and other contours.]
{
	\includegraphics[width=0.3\textwidth]{images/mask_1}
}
\subfigure[Found contour of cloth.]
{
...
%Explain problem with 180+- and so forth.
