...
\begin{figure}[htpb]
  \centering
  \subfloat[Input]{\includegraphics[width=0.2\textwidth]{images/unimodal6-input}}
  \quad           
...
\begin{figure}[htpb]
  \centering
  \subfloat[Input]{\includegraphics[width=0.2\textwidth]{images/multimodal56-input}}
  \quad           
  \subfloat[Hue histogram]{\includegraphics[width=0.48\textwidth]{images/multimodal56}}
