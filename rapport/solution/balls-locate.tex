...
\begin{figure}[H]
  \centering
  \subfloat[No clutter]{\label{fig:gull}\includegraphics[width=0.48\textwidth]{images/detect2.jpg}}
  \quad           
  \subfloat[Clutter]{\label{fig:tiger}\includegraphics[width=0.48\textwidth]{images/detect1.jpg}}
