...
\label{fig:tablergb}
\end{figure}
When looking at the RGB color space in figure \ref{fig:tablergb} the identification of the cloth becomes more difficult.\fxfatal*{Forstaar ikke hvad der siges}{ As presumed, the change in the RGB color space is more significant for the cloth (fourth image) than the other images compared to the HSB color space \ref{fig:tablehsv}. This is because of the hue ability to be, in theory, illumination invariant.}
